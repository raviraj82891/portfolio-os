...
export const useOS = create<OSState>((set, get) => ({
  ...
  openWindow: (appId, title) => {
    ...
    const newWindow: WindowState = {
      ...
      x: 100 + offset,
      y: 60 + offset,
      width: appId === 'terminal' ? 750 : appId === 'snake' ? 520 : appId === 'chess' ? 500 : appId === 'gemini-chat' ? 600 : appId === 'compiler' ? 840 : 800,
      height: appId === 'terminal' ? 480 : appId === 'snake' ? 600 : appId === 'chess' ? 650 : appId === 'gemini-chat' ? 550 : appId === 'compiler' ? 620 : 550,
      isMinimized: false,
      isMaximized: false,
